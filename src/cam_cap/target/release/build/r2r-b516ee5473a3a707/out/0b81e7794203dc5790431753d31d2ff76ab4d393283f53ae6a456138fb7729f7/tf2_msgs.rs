...
pub mod msg {
    ...
    impl TF2Error {
        pub const CONNECTIVITY_ERROR: _bindgen_ty_161 = tf2_msgs__msg__TF2Error__CONNECTIVITY_ERROR;
        pub const EXTRAPOLATION_ERROR: _bindgen_ty_162 = tf2_msgs__msg__TF2Error__EXTRAPOLATION_ERROR;
        pub const INVALID_ARGUMENT_ERROR: _bindgen_ty_163 = tf2_msgs__msg__TF2Error__INVALID_ARGUMENT_ERROR;
        pub const LOOKUP_ERROR: _bindgen_ty_160 = tf2_msgs__msg__TF2Error__LOOKUP_ERROR;
        pub const NO_ERROR: _bindgen_ty_159 = tf2_msgs__msg__TF2Error__NO_ERROR;
        pub const TIMEOUT_ERROR: _bindgen_ty_164 = tf2_msgs__msg__TF2Error__TIMEOUT_ERROR;
        pub const TRANSFORM_ERROR: _bindgen_ty_165 = tf2_msgs__msg__TF2Error__TRANSFORM_ERROR;
    }
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(default)]
