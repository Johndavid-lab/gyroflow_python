pub mod msg {
    ...
    impl ImageMarker {
        pub const ADD: _bindgen_ty_171 = visualization_msgs__msg__ImageMarker__ADD;
        pub const CIRCLE: _bindgen_ty_166 = visualization_msgs__msg__ImageMarker__CIRCLE;
        pub const LINE_LIST: _bindgen_ty_168 = visualization_msgs__msg__ImageMarker__LINE_LIST;
        pub const LINE_STRIP: _bindgen_ty_167 = visualization_msgs__msg__ImageMarker__LINE_STRIP;
        pub const POINTS: _bindgen_ty_170 = visualization_msgs__msg__ImageMarker__POINTS;
        pub const POLYGON: _bindgen_ty_169 = visualization_msgs__msg__ImageMarker__POLYGON;
        pub const REMOVE: _bindgen_ty_172 = visualization_msgs__msg__ImageMarker__REMOVE;
    }
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(default)]
    ...
    impl InteractiveMarkerControl {
        pub const BUTTON: _bindgen_ty_181 = visualization_msgs__msg__InteractiveMarkerControl__BUTTON;
        pub const FIXED: _bindgen_ty_177 = visualization_msgs__msg__InteractiveMarkerControl__FIXED;
        pub const INHERIT: _bindgen_ty_176 = visualization_msgs__msg__InteractiveMarkerControl__INHERIT;
        pub const MENU: _bindgen_ty_180 = visualization_msgs__msg__InteractiveMarkerControl__MENU;
        pub const MOVE_3D: _bindgen_ty_186 = visualization_msgs__msg__InteractiveMarkerControl__MOVE_3D;
        pub const MOVE_AXIS: _bindgen_ty_182 = visualization_msgs__msg__InteractiveMarkerControl__MOVE_AXIS;
        pub const MOVE_PLANE: _bindgen_ty_183 = visualization_msgs__msg__InteractiveMarkerControl__MOVE_PLANE;
        pub const MOVE_ROTATE: _bindgen_ty_185 = visualization_msgs__msg__InteractiveMarkerControl__MOVE_ROTATE;
        pub const MOVE_ROTATE_3D: _bindgen_ty_188 = visualization_msgs__msg__InteractiveMarkerControl__MOVE_ROTATE_3D;
        pub const NONE: _bindgen_ty_179 = visualization_msgs__msg__InteractiveMarkerControl__NONE;
        pub const ROTATE_3D: _bindgen_ty_187 = visualization_msgs__msg__InteractiveMarkerControl__ROTATE_3D;
        pub const ROTATE_AXIS: _bindgen_ty_184 = visualization_msgs__msg__InteractiveMarkerControl__ROTATE_AXIS;
        pub const VIEW_FACING: _bindgen_ty_178 = visualization_msgs__msg__InteractiveMarkerControl__VIEW_FACING;
    }
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(default)]
    ...
    impl InteractiveMarkerFeedback {
        pub const BUTTON_CLICK: _bindgen_ty_208 = visualization_msgs__msg__InteractiveMarkerFeedback__BUTTON_CLICK;
        pub const KEEP_ALIVE: _bindgen_ty_205 = visualization_msgs__msg__InteractiveMarkerFeedback__KEEP_ALIVE;
        pub const MENU_SELECT: _bindgen_ty_207 = visualization_msgs__msg__InteractiveMarkerFeedback__MENU_SELECT;
        pub const MOUSE_DOWN: _bindgen_ty_209 = visualization_msgs__msg__InteractiveMarkerFeedback__MOUSE_DOWN;
        pub const MOUSE_UP: _bindgen_ty_210 = visualization_msgs__msg__InteractiveMarkerFeedback__MOUSE_UP;
        pub const POSE_UPDATE: _bindgen_ty_206 = visualization_msgs__msg__InteractiveMarkerFeedback__POSE_UPDATE;
    }
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(default)]
    ...
    impl InteractiveMarkerUpdate {
        pub const KEEP_ALIVE: _bindgen_ty_211 = visualization_msgs__msg__InteractiveMarkerUpdate__KEEP_ALIVE;
        pub const UPDATE: _bindgen_ty_212 = visualization_msgs__msg__InteractiveMarkerUpdate__UPDATE;
    }
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(default)]
    pub struct Marker {
    ...
    #[allow(non_upper_case_globals)]
    impl Marker {
        pub const ADD: _bindgen_ty_201 = visualization_msgs__msg__Marker__ADD;
        pub const ARROW: _bindgen_ty_189 = visualization_msgs__msg__Marker__ARROW;
        pub const CUBE: _bindgen_ty_190 = visualization_msgs__msg__Marker__CUBE;
        pub const CUBE_LIST: _bindgen_ty_195 = visualization_msgs__msg__Marker__CUBE_LIST;
        pub const CYLINDER: _bindgen_ty_192 = visualization_msgs__msg__Marker__CYLINDER;
        pub const DELETE: _bindgen_ty_203 = visualization_msgs__msg__Marker__DELETE;
        pub const DELETEALL: _bindgen_ty_204 = visualization_msgs__msg__Marker__DELETEALL;
        pub const LINE_LIST: _bindgen_ty_194 = visualization_msgs__msg__Marker__LINE_LIST;
        pub const LINE_STRIP: _bindgen_ty_193 = visualization_msgs__msg__Marker__LINE_STRIP;
        pub const MESH_RESOURCE: _bindgen_ty_199 = visualization_msgs__msg__Marker__MESH_RESOURCE;
        pub const MODIFY: _bindgen_ty_202 = visualization_msgs__msg__Marker__MODIFY;
        pub const POINTS: _bindgen_ty_197 = visualization_msgs__msg__Marker__POINTS;
        pub const SPHERE: _bindgen_ty_191 = visualization_msgs__msg__Marker__SPHERE;
        pub const SPHERE_LIST: _bindgen_ty_196 = visualization_msgs__msg__Marker__SPHERE_LIST;
        pub const TEXT_VIEW_FACING: _bindgen_ty_198 = visualization_msgs__msg__Marker__TEXT_VIEW_FACING;
        pub const TRIANGLE_LIST: _bindgen_ty_200 = visualization_msgs__msg__Marker__TRIANGLE_LIST;
    }
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(default)]
    ...
    #[allow(non_upper_case_globals)]
    impl MenuEntry {
        pub const FEEDBACK: _bindgen_ty_173 = visualization_msgs__msg__MenuEntry__FEEDBACK;
        pub const ROSLAUNCH: _bindgen_ty_175 = visualization_msgs__msg__MenuEntry__ROSLAUNCH;
        pub const ROSRUN: _bindgen_ty_174 = visualization_msgs__msg__MenuEntry__ROSRUN;
    }
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(default)]
    pub struct MeshFile {
