...
mod core_sys {
	...
	extern "C" {
		...
		pub fn cv_float16_t_float16_t(ocvrs_return: *mut Result<*mut c_void>);
		pub fn cv_float16_t_float16_t_float(x: f32, ocvrs_return: *mut Result<*mut c_void>);
		pub fn cv_float16_t_operator_float_const(instance: *const c_void, ocvrs_return: *mut Result<f32>);
		pub fn cv_float16_t_fromBits_unsigned_short(w: u16, ocvrs_return: *mut Result<*mut c_void>);
		pub fn cv_float16_t_zero(ocvrs_return: *mut Result<*mut c_void>);
		pub fn cv_float16_t_bits_const(instance: *const c_void, ocvrs_return: *mut Result<u16>);
		pub fn cv_float16_t_implicitClone_const(instance: *const c_void) -> *mut c_void;
		pub fn cv_float16_t_delete(instance: *mut c_void);
